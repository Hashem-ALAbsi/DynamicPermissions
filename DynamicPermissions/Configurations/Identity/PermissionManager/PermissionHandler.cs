...
namespace DynamicPermissions.Configurations.Identity.PermissionManager
{
    public class PermissionHandler : AuthorizationHandler<PermissionRequirement>
    {
        ...
        public PermissionHandler(IHttpContextAccessor contextAccessor, IMemoryCache memoryCache, IDataProtectionProvider dataProtectionProvider, IAppSettingService appSettingService, SignInManager<ApplicationUser> signInManager, UserManager<ApplicationUser> userManager, RoleManager<Role> roleManager)
        {
